from r_lxml.etree import XPath, ElementBase
from r_lxml.html import fromstring, XHTML_NAMESPACE
from r_lxml.html import _forms_xpath, _options_xpath, _nons, _transform_result
from r_lxml.html import defs
import copy
