...
from r_lxml.includes.etreepublic cimport _Document, _Element, ElementBase, ElementClassLookup
from r_lxml.includes.etreepublic cimport elementFactory, import_lxml__etree, textOf, pyunicode
from r_lxml.includes.tree cimport const_xmlChar, _xcstr
from r_lxml cimport python
from r_lxml.includes cimport tree
...
cdef class ElementMaker:
    ...
    Example::
      ...
      >>> from r_lxml.etree import tostring
...
def set_default_parser(new_parser = None):
    ...
    if new_parser is None:
        ...
        raise TypeError, u"parser must inherit from r_lxml.etree.XMLParser"
