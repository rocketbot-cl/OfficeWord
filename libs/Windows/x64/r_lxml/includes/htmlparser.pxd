...
from r_lxml.includes.tree cimport xmlDoc
from r_lxml.includes.tree cimport xmlInputReadCallback, xmlInputCloseCallback
from r_lxml.includes.xmlparser cimport xmlParserCtxt, xmlSAXHandler, xmlSAXHandlerV1
