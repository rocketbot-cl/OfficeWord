...
from r_lxml.includes cimport tree, config
from r_lxml.includes.tree cimport xmlDoc, xmlNode, xmlAttr, xmlNs, _isElement, _getNs
from r_lxml.includes.tree cimport const_xmlChar, xmlChar, _xcstr
from r_lxml.python cimport _cstr, _isString
from r_lxml.includes cimport xpath
from r_lxml.includes cimport c14n
...
from r_lxml import _elementpath
