...
import sys
import os.path
from r_lxml import etree as _etree # due to validator __init__ signature


# some compat stuff, borrowed from r_lxml.html
try:
    unicode
except NameError:
    # Python 3
...
class Schematron(_etree._Validator):
    ...
    Here is a usage example::
      ...
      >>> from r_lxml.isoschematron import Schematron
