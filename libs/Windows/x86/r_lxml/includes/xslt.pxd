from r_lxml.includes.tree cimport xmlDoc, xmlNode, xmlDict, xmlChar, const_xmlChar, xmlOutputBuffer
from r_lxml.includes.xmlerror cimport xmlGenericErrorFunc
from r_lxml.includes.xpath cimport xmlXPathContext, xmlXPathFunction
